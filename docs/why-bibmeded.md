...
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **Multi-database search built-in** | ✅ PubMed + OpenAlex + CrossRef + Semantic Scholar + Lens.org (extensible) | ❌ (import only) | ❌ (import only) | ❌ (import only) | ⚠️ via WoS/Scopus importers | ❌ (file import) |
