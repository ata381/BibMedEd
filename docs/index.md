...
For first-run exploration, use **Explore sample project** on the empty workspace to populate a clearly labeled synthetic corpus and test the analysis workflow end-to-end right away.
